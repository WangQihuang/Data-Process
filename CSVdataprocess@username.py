...
outputfilepass = r'C:\Users\UserName\Desktop\ICPMS_data.xlsx'

#######################################################################################################

class dataprocess():
    def csvprocess(self,stdcalnum,plnum,inputfilepass):
        # 将csv文件转为xisx文件
...
if __name__ == '__main__':
    ...
    dataprocess.csvprocess('',stdcalnum,plnum,inputfilepass)